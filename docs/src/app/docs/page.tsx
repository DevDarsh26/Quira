...
export default function DocsPage() {
  return (
    <div className="flex flex-col pb-32">
      ...
      {/* --- V3.0 FEATURES --- */}
      <AnimatedSection direction="none" id="v3-features" className="scroll-mt-32 mb-20">
        <h2 className="text-2xl font-semibold tracking-tight mb-4 text-zinc-900 dark:text-white">
          v3.0 Advanced Features
        </h2>
        <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
          Quira v3.0 introduces three massive capabilities designed for edge deployments, complex multi-hop reasoning, and ultimate token savings. All of these are opt-in for strict backward compatibility.
        </p>
        
        <div className="grid sm:grid-cols-3 gap-4">
          <div className="p-5 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]">
            <h3 className="font-medium mb-1.5 text-zinc-900 dark:text-white text-[15px]">Quira Edge (Zero-Server)</h3>
            <p className="text-[14px] text-zinc-500 dark:text-zinc-400">Run entirely locally without Redis or Qdrant using embedded <code>DuckDB</code> or <code>sqlite-vec</code>. Perfect for desktop or edge apps.</p>
          </div>
          <div className="p-5 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]">
            <h3 className="font-medium mb-1.5 text-zinc-900 dark:text-white text-[15px]">GraphRAG</h3>
            <p className="text-[14px] text-zinc-500 dark:text-zinc-400">Extracts Entity-Relationship triplets on ingestion. Parallely traverses this Knowledge Graph during search to solve multi-hop reasoning.</p>
          </div>
          <div className="p-5 rounded-lg border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]">
            <h3 className="font-medium mb-1.5 text-zinc-900 dark:text-white text-[15px]">Agentic Routing</h3>
            <p className="text-[14px] text-zinc-500 dark:text-zinc-400">Zero-latency heuristics instantly catch conversational chitchat (e.g. &quot;Hi&quot;) and bypass the vector DB entirely to save 100% of tokens.</p>
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection direction="none" id="provider-abstraction" className="scroll-mt-32 mb-20">
        ...
        <div className="rounded-lg overflow-hidden border border-zinc-200 dark:border-white/10 bg-white dark:bg-[#0a0a0a]">
          ...
          <div className="p-5 font-mono text-[13px] leading-relaxed bg-zinc-900 dark:bg-transparent overflow-x-auto text-zinc-300">
            ...
            <span>    vector_store=</span><span className="text-[#98c379]">&quot;qdrant&quot;</span>,  <span className="text-zinc-500 italic"># or &quot;pinecone&quot;, &quot;pgvector&quot;, &quot;neo4j&quot;, &quot;mongodb&quot;...</span><br/>
